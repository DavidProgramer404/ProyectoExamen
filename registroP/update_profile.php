...
if(isset($_POST['update_profile'])){
   ...
   if(!empty($update_image)){
      if($update_image_size > 2000000){
         ...
         $message[] = 'La imagen sé ha subido correctamente!';
      }
   }
   ...
   <form action="" method="post" enctype="multipart/form-data">
      ...
      <div class="flex">
         ...
         <div class="inputBox">
            ...
            <input type="password" name="new_pass" placeholder="ingrese nueva clave" class="box">
      ...
      <a href="home.php" class="delete-btn">Volver atras</a>
   </form>
