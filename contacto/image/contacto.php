    ...
    <header class="hero">
        ...
        <div class="hero__container container">
            ...
            <div class="hero__texts">
                ...
                <a href="index.html" class="hero__cta">Ir a panel de control principal </a>
            </div>
    ...
    <main class="main">
        ...
        <section class="about container">
            ...
            <div class="about__course">
                ...
                <p class="about__paragraph">Soporte informático y mantenimiento de computadores con mas de 15 años de experiencia con conocimientos de instalaciones de Sistemas operativos Windows, Linux, Mac, y conocimientos sobre hardware software informático, eh instalaciones
                    de redes.
                </p>

                <a href="index.html" class="cta">Contactar con David</a>
            </div>
        ...
        <section class="course container">
            ...
            <div class="course__about">
                <h2 class="title">Agendar presupuesto tecnico</h2>
